...
class FlutterMadaDropDown<T> extends StatefulWidget {
  const FlutterMadaDropDown({
    super.key,
    this.controller,
  ...
  @override
  State<FlutterMadaDropDown<T>> createState() => _FlutterFlowDropDownState<T>();
}

class _FlutterFlowDropDownState<T> extends State<FlutterMadaDropDown<T>> {
