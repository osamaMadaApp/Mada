...
Widget wrapWithModel<T extends FlutterMadaModel>({
  required T model,
...
T createModel<T extends FlutterMadaModel>(
...
abstract class FlutterMadaModel<W extends Widget> {
...
class FlutterMadaDynamicModels<T extends FlutterMadaModel> {
  FlutterMadaDynamicModels(this.defaultBuilder);
